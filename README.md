...
customers share the same IP address and happen to visit npipe.io, they will be
able to download each other's files.

VPN users sharing the same exit node will encounter the same problem.
